...
public:
  ...
  static Result
  pointToPointICP(const std::vector<Eigen::Vector3d> &source_points,
...
private:
  ...
  static Eigen::Matrix4d makeSE3(const Eigen::Matrix3d &R,
  ...
  static size_t trimCorrespondences(uint32_t *indices, const double *dist_sq,
                                    size_t num_corr);
